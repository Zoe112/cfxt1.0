...
<div>
    <div>
        ...
        <option value="1">软件初级工程师</option>   
        <option value="2">软件中级工程师</option> 
        <option value="3">软件高级工程师</option>
    </select>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <c:forEach items="${passList}" var="pl" varStatus="status">
	        <tr>
	            <td style="text-align:center">${status.index + 1}</td>
	            <td>${pl.subject}</td>
	            <td>2013-12-20 04:47</td>
	            <td>${pl.username}</td>
	            <td style="text-align:center">${pl.score}</td>
